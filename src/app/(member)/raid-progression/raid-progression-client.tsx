...
const BossPanel = ({
    ...
    selectedDifficulty,
    basePath,
}: BossPanelProps & { basePath: "/roster" | "/character" }) => {
...
// Main Component
type RaidProgressionPageProps = {
    userRole: "member" | "officer"
}

export function RaidProgressionPageClient({ userRole }: RaidProgressionPageProps): JSX.Element {
    const characterBasePath = userRole === "officer" ? "/roster" : "/character"
