...
export const encounterIcon = new Map<number, string>([
    ...
    [2608, 'https://assets2.mythictrap.com/nerubar-palace/background_finals/silken-court-custom.png'], // The Silken Court
...
export const currencyIcon = new Map<number, { url: string; name: string }>([
    // TWW SEASON 1
    [3116, { url: 'https://wow.zamimg.com/images/wow/icons/large/inv_alchemy_90_reagent_green.jpg', name: 'Essence of Kajamite' }],
    [2914, { url: 'https://www.raidbots.com/static/images/icons/56/inv_crestupgrade_xalatath_weathered.png', name: 'Weathered Harbinger Crest' }],
    [2915, { url: 'https://www.raidbots.com/static/images/icons/56/inv_crestupgrade_xalatath_carved.png', name: 'Carved Harbinger Crest' }],
    [2916, { url: 'https://www.raidbots.com/static/images/icons/56/inv_crestupgrade_xalatath_runed.png', name: 'Runed Harbinger Crest' }],
    [2917, { url: 'https://www.raidbots.com/static/images/icons/56/inv_crestupgrade_xalatath_gilded.png', name: 'Gilded Harbinger Crest' }],
    [3008, { url: 'https://www.raidbots.com/static/images/icons/56/inv_valorstone_base.png', name: 'Valorstone' }],
    [211296, { url: 'https://wow.zamimg.com/images/wow/icons/large/inv_spark_whole_violet.jpg', name: 'Spark of Omen' }],
    // TWW SEASON 2
    [2813, { url: 'https://wow.zamimg.com/images/wow/icons/large/inv_ability_web_beam.jpg', name: 'Harmonized Silk' }],
    [3107, { url: 'https://wow.zamimg.com/images/wow/icons/large/inv_crestupgrade_undermine_weathered.jpg', name: 'Weathered Undermine Crest' }],
    [3108, { url: 'https://wow.zamimg.com/images/wow/icons/medium/inv_crestupgrade_undermine_carved.jpg', name: 'Carved Undermine Crest' }],
    [3109, { url: 'https://wow.zamimg.com/images/wow/icons/medium/inv_crestupgrade_undermine_runed.jpg', name: 'Runed Undermine Crest' }],
    [3110, { url: 'https://wow.zamimg.com/images/wow/icons/medium/inv_crestupgrade_undermine_gilded.jpg', name: 'Gilded Undermine Crest' }],
    [230906, { url: 'https://wow.zamimg.com/images/wow/icons/large/inv_spark_whole_orange.jpg', name: 'Spark of Fortunes' }],
    [230936, { url: 'https://wow.zamimg.com/images/wow/icons/large/inv_crestupgrade_xalatath_runed_enchanted.jpg', name: 'Enchanted Runed Undermine Crest' }],
    [230935, { url: 'https://wow.zamimg.com/images/wow/icons/large/inv_crestupgrade_xalatath_gilded_enchanted-.jpg', name: 'Enchanted Gilded Undermine Crest' }]
])
